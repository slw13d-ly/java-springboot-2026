...
public class BoardController {
    ...
    @PostMapping("/create") 
    // public String create(@Valid BoardForm boardForm, BindingResult bindingResult, HttpSession session) throws Exception { 변경
    ...
    // public String showEditForm(@PathVariable("boardId") Long boardId, Model model, HttpSession session) { 변경
